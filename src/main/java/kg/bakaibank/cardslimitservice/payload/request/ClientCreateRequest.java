...
public record ClientCreateRequest(
    ...
    @NotBlank(message = "firstname can't be empty or null or empty or blank")
    @Size(min = 1, max = 50, message = "firstname must be minimum size = 1, max size = 50(include)")
    String firstname,

    @NotBlank(message = "lastname can't be empty or null or empty or blank")
    ...
    @NotBlank(message = "phoneNumber can't be empty or null or empty or blank")
